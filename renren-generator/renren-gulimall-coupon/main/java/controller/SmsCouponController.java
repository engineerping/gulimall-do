 ...
 */
@RestController
@RequestMapping("${moduleName}/smscoupon")
public class SmsCouponController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:smscoupon:list")
    ...
    //@RequiresPermissions("${moduleName}:smscoupon:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:smscoupon:save")
    ...
    //@RequiresPermissions("${moduleName}:smscoupon:update")
    ...
    //@RequiresPermissions("${moduleName}:smscoupon:delete")
