 ...
 */
@RestController
@RequestMapping("${moduleName}/smsseckillsession")
public class SmsSeckillSessionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:smsseckillsession:list")
    ...
    //@RequiresPermissions("${moduleName}:smsseckillsession:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:smsseckillsession:save")
    ...
    //@RequiresPermissions("${moduleName}:smsseckillsession:update")
    ...
    //@RequiresPermissions("${moduleName}:smsseckillsession:delete")
