...
import ${package}.${moduleName}.service.SmsHomeAdvService;
 ...
 */
@RestController
@RequestMapping("${moduleName}/smshomeadv")
public class SmsHomeAdvController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:smshomeadv:list")
    ...
    //@RequiresPermissions("${moduleName}:smshomeadv:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:smshomeadv:save")
    ...
    //@RequiresPermissions("${moduleName}:smshomeadv:update")
    ...
    //@RequiresPermissions("${moduleName}:smshomeadv:delete")
