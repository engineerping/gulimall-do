...
import ${package}.${moduleName}.service.SmsCouponSpuCategoryRelationService;
 ...
 */
@RestController
@RequestMapping("${moduleName}/smscouponspucategoryrelation")
public class SmsCouponSpuCategoryRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:smscouponspucategoryrelation:list")
    ...
    //@RequiresPermissions("${moduleName}:smscouponspucategoryrelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:smscouponspucategoryrelation:save")
    ...
    //@RequiresPermissions("${moduleName}:smscouponspucategoryrelation:update")
    ...
    //@RequiresPermissions("${moduleName}:smscouponspucategoryrelation:delete")
