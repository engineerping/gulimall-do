 ...
 */
@RestController
@RequestMapping("${moduleName}/smshomesubjectspu")
public class SmsHomeSubjectSpuController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:smshomesubjectspu:list")
    ...
    //@RequiresPermissions("${moduleName}:smshomesubjectspu:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:smshomesubjectspu:save")
    ...
    //@RequiresPermissions("${moduleName}:smshomesubjectspu:update")
    ...
    //@RequiresPermissions("${moduleName}:smshomesubjectspu:delete")
