...
import ${package}.${moduleName}.service.SmsSkuLadderService;
 ...
 */
@RestController
@RequestMapping("${moduleName}/smsskuladder")
public class SmsSkuLadderController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:smsskuladder:list")
    ...
    //@RequiresPermissions("${moduleName}:smsskuladder:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:smsskuladder:save")
    ...
    //@RequiresPermissions("${moduleName}:smsskuladder:update")
    ...
    //@RequiresPermissions("${moduleName}:smsskuladder:delete")
