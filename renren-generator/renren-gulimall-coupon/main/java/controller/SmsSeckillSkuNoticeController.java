...
import ${package}.${moduleName}.service.SmsSeckillSkuNoticeService;
 ...
 */
@RestController
@RequestMapping("${moduleName}/smsseckillskunotice")
public class SmsSeckillSkuNoticeController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:smsseckillskunotice:list")
    ...
    //@RequiresPermissions("${moduleName}:smsseckillskunotice:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:smsseckillskunotice:save")
    ...
    //@RequiresPermissions("${moduleName}:smsseckillskunotice:update")
    ...
    //@RequiresPermissions("${moduleName}:smsseckillskunotice:delete")
