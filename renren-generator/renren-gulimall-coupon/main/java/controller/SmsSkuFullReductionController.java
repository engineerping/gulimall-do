 ...
 */
@RestController
@RequestMapping("${moduleName}/smsskufullreduction")
public class SmsSkuFullReductionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:smsskufullreduction:list")
    ...
    //@RequiresPermissions("${moduleName}:smsskufullreduction:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:smsskufullreduction:save")
    ...
    //@RequiresPermissions("${moduleName}:smsskufullreduction:update")
    ...
    //@RequiresPermissions("${moduleName}:smsskufullreduction:delete")
