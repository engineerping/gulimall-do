...
import ${package}.${moduleName}.service.SmsSpuBoundsService;
 ...
 */
@RestController
@RequestMapping("${moduleName}/smsspubounds")
public class SmsSpuBoundsController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:smsspubounds:list")
    ...
    //@RequiresPermissions("${moduleName}:smsspubounds:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:smsspubounds:save")
    ...
    //@RequiresPermissions("${moduleName}:smsspubounds:update")
    ...
    //@RequiresPermissions("${moduleName}:smsspubounds:delete")
