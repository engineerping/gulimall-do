...
import ${package}.${moduleName}.service.SmsSeckillSkuRelationService;
 ...
 */
@RestController
@RequestMapping("${moduleName}/smsseckillskurelation")
public class SmsSeckillSkuRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("${moduleName}:smsseckillskurelation:list")
    ...
    //@RequiresPermissions("${moduleName}:smsseckillskurelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("${moduleName}:smsseckillskurelation:save")
    ...
    //@RequiresPermissions("${moduleName}:smsseckillskurelation:update")
    ...
    //@RequiresPermissions("${moduleName}:smsseckillskurelation:delete")
